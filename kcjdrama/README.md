...
Git remotes for this whole site tree:

| Remote | URL |
|--------|-----|
| `origin` | https://github.com/elandrydenhall/kcjdrama-wp (public) |
| `beast` | `elan@10.0.0.194:/mnt/drive-a/wp-dev/repos/kcjdrama-wp.git` |

After a BeeLink commit: `git push origin` and `git push beast`, then on Beast `ssh 10.0.0.194 "git -C /mnt/drive-a/wp-dev/kcjdrama-wp pull"`.
